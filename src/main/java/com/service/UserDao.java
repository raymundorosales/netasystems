...
public class UserDao implements IUserDao {
	...
	/**
	 * Metodo para obtener la llave primaria USER_NO de la tabla NS_USERS buscando con el correo
	 * @param username contendra el correo con el que queremos buscar el registro
	 * @return userNo devuelve la llave primaria obetenida, en caso de que no encuentre registro devolvera 0
	 */
	@Override
	 ...
	 * @return userNo es el valor de la siguiente llave primaria que se debe insertar en la tabla
	 */
	@Override
